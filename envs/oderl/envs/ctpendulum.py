...
class CTPendulum(BaseEnv):  # pylint: disable=abstract-method
    ...
    metadata = {"render.modes": ["human", "rgb_array"], "video.frames_per_second": 30}  # pyright: ignore
    ...
    def df_du(self, state):
        ...
        m, l = self.mass, self.l  # noqa: E741
    ...
    def torch_rhs(self, state, action):
        ...
        g, m, l = self.g, self.mass, self.l  # noqa: E741
        if state.shape[-1] == 2:
    ...
    def render(self, mode="human", **kwargs):
        if self.viewer is None:
            ...
            axle = rendering.make_circle(0.05)  # pyright: ignore
